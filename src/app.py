...
activities = {
    ...
    "Basketball": {
        "description": "Team sport focusing on shooting, dribbling, and defense",
        "schedule": "Mondays and Wednesdays, 4:00 PM - 5:30 PM",
        "max_participants": 25,
        "participants": ["alex@mergington.edu"]
    },
    "Soccer": {
        "description": "Outdoor sport emphasizing teamwork and athletic conditioning",
        "schedule": "Tuesdays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 22,
        "participants": ["james@mergington.edu", "nicole@mergington.edu"]
    },
    "Painting Studio": {
    ...
    "Science Club": {
        "description": "Explore experiments and scientific discoveries through hands-on projects",
